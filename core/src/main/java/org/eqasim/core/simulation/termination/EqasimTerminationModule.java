...
public class EqasimTerminationModule extends AbstractEqasimExtension {
	...
	protected void installEqasimExtension() {
		...
		bind(TerminationState.class).in(Singleton.class);
	}
	...
	EqasimTerminationCriterion provideEqasimTerminationCriterion(ControllerConfigGroup controllerConfig,
		...
		int horizon = terminationConfig.getHorizon();
		...
		return new EqasimTerminationCriterion(firstIteration, lastIteration, horizon, indicators, criteria, writer, terminationState);
	}
