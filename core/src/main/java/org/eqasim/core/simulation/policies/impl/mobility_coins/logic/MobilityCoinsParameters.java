...
public class MobilityCoinsParameters implements ParameterDefinition {
    ...
    // Path to pre-computed PT stop counts CSV file (optional, used by SUFFI and other schemes)
    // Format: person_id;pt_home;pt_work;pt_education
    // Generated by PtStopsPrecomputer (counts stops within 500 m of each activity location)
    // Hinweis: wird von agentParamsFilePath abgelöst – beide Felder bleiben erhalten
    public String ptStopsFilePath = "";

    // === Einheitliche Agenten-Parameter-CSV (ersetzt alle scheme-spezifischen Einzeldateien) ===
    // Pfad zur CSV-Datei mit allen vorberechneten Agenten-Parametern für alle Allocation-Schemes.
    // Generiert durch AgentParametersPrecomputer (einmalig vor dem ersten Simulationslauf).
    // Format: person_id;household_id;age;employed;homeoffice;education;
    //         has_driving_license;has_pt_subscription;car_availability;bicycle_availability;
    //         income;high_income;household_size;
    //         pt_home;pt_work;pt_education;home_zone;work_zone;education_zone
